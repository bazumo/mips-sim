...
/**
 * A simulator class used to simulate any architecture. This class is supposed to be instantiated directly, and while sub-classing is possible it is not required.
 */
export default class Simulator {
  ...
  /**
   * Loads the view specified by dataView into memory at position pos. dataView may either be a DataView, ArrayBuffer or a Uint8Array.
   *
   * Please make sure you're using the correct endianness. Many modern CPUs use Little Endian while many older CPUs use Big Endian. Endianness cannot be set with typed arrays like Uint32Array, which is why DataViews are more favorable.
   */
